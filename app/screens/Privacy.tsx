                ...
                <View>                                                         
                    <View style={styles.headerContainer}>
                        ...
                        <Text style={styles.followersText}> 
                            ...
                            [List of data automatically collected when the user simply visits the application]
                            Other personal data is collected when you perform the following operations on the platform:
                            like a post
                            react to a post
                            create a channel
                            reply to a message
                            This data is kept by the data controller under reasonable security conditions, for a period of : *3 years
                            ...
                            The JOIN application is hosted by :
                            JOIN
                            13 rue Théodore Blanc
                            Contact join.us@gmail.com
                        ...
                        <Text style={styles.followersText}> 
                            ...
                            By post at the following address: 13 rue Théodore Blanc ;
                            By telephone on 07 82 25 66 28 ;
                            By e-mail: mathis.join@gmail.com.
                            Article 4.2: The Data Protection Officer (DPO)
                            The company's or manager's data protection delegate is :
                        ...
                        <Text style={styles.followersText}> 
                            ...
                            Right to limitation (Article 18 of the GDPR) and opposition to data processing (Article 21 of the GDPR);
                            ...
                            Right to have recourse to the competent supervisory authority (Article 77 of the RGPD).
                            To exercise your rights, please send your letter to 13 Rue Théodore Blanc or by email to mathis.join@gmail.com
